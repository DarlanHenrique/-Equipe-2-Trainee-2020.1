...
<body>
    ...
    <main class='all'>
        <div class='who'>
            <h1>Quem somos?</h1>
            <p>Nossa empresa foi fundada em dezembro de 2016, por um grupo de jovens empreendedores com intuito de nos tornarmos uma empresa alternativa para a produção e venda de roupas infantis, fugindo das grandes marcas, já conceituadas do mercado, mas
                produzindo de maneira semi-artesanal nossos produtos e conquistando o mercado.</p>
        </div>
