              ...
              <div class="col-sm pr-1">
                <div class="card text-center border-dark mb-3 bg-light mb-3" style="width: 18rem;">
                  <div class="card-body">
                    ...
                    <a href="/admin/categorias" class="btn btn-outline-dark">Visitar</a>
                  </div>
                </div>
              </div>
              <div class="col-sm pr-1">
                <div class="card text-center border-dark mb-3 bg-light mb-3" style="width: 18rem;">
                  <div class="card-body">
                    <h5 class="card-title font-weight-bold "><i class="fa fa-users" aria-hidden="true"></i>
                      Listagem de Usuários</h5>                        
                    <a href="/admin/usuarios" class="btn btn-outline-dark">Visitar</a>
                  </div>
                </div>  
              </div>
            </div>
      ...
      <footer>
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm flex-center text-center">
              <img src="/../public/img/Da_lã_Logo_2.png" width="63" height="42" alt="Logotipo Da Lã">
